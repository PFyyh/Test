...
<body class="main_body">
	<div class="layui-layout layui-layout-admin">
			...
			<div class="layui-main mag0">
			    ...
			    <ul class="layui-nav top_menu">
					<li class="layui-nav-item" id="userInfo">
						<a href="javascript:;"><span class="adminName">欢迎：某某某用户</span></a>
			...
			<div class="layui-tab mag0" lay-filter="bodyTab" id="top_tabs_box">
				...
				<div class="layui-tab-content clildFrame">
					<div class="layui-tab-item layui-show">
						<iframe src="page/testermain.html"></iframe>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="layui-footer footer">
			<p><span>&copy;2018 【软件工程综合实践三小组】 All rights reserved.</span></p>
		</div>
	</div>
	...
	<script type="text/javascript" src="<%=request.getContextPath() %>/js/indextester.js"></script>
</body>
</html>